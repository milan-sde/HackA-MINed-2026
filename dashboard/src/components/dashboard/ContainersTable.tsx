...
import { ChevronUp, ChevronDown, ChevronsUpDown, Search, Filter, AlertCircle, Eye, Flag } from "lucide-react";
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-border bg-muted/30">
                ...
                <th className={thCls}>Key Factors</th>
                    ...
                    <td className={tdCls}>
                      <div className="flex flex-wrap gap-1 max-w-[200px]">
                        {container.keyRiskFactors.slice(0, 2).map((f) => (
                          <span key={f} className="inline-block bg-secondary text-secondary-foreground rounded px-1.5 py-0.5 text-[10px]">
                            {f}
                          </span>
                        ))}
                      </div>
