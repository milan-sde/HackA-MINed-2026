...
import { MOCK_RISKY_EXPORTERS, MOCK_RISKY_IMPORTERS } from "@/data/mockData";
      ...
      <CardContent>
        <Tabs defaultValue="exporters">
          ...
          <TabsContent value="exporters">
            <EntityBarChart data={MOCK_RISKY_EXPORTERS} label="Exporter" />
          </TabsContent>
          <TabsContent value="importers">
            <EntityBarChart data={MOCK_RISKY_IMPORTERS} label="Importer" />
          </TabsContent>
        </Tabs>
      </CardContent>
    </Card>
